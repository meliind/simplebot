...
client.log("Auth Token : "EwyEAq3RonQQ6B4mUjd9.8iTUF0fIHciq9yxrPbwOEq.O2ObCc1K8w57HZyOhNxSdGZ6fyPh1cPHmnnJuubMwjo=") str(client.authToken))

channel = LineChannel(client)
client.log("Channel Access Token : "HIwftzg4a3NFre1DXEkyvRHW0dpJkTcVfGCYB4zikHZNSftFl2OLXwCzLzgNiGJDjThzMBE96CQDTMHWyLdRdytAKBdYqlkGOXwVQrg4ZtbNye0pU1hzzdEs57yeLJSbrikInac8PADha7ylx4ucBHPpok1O6QNHjuH/VxKgw3rDTofK697pgpyqnWXJQVKW") str(channel.channelAccessToken))
                ...
                if msg.text != None:
                    if msg.toType == 2:
                        ...
                        if may in str(msg.contentMetadata) and 'MENTION' in str(msg.contentMetadata):
                            pilih = ['yang tag saya semoga jomblo seumur hidup','ngapain tag tag woe, kangen?','ada apa ini? ko di tag?','duhh kena tag, dianya kesepian kali yah','gak usah tag, gift tikel aja']
